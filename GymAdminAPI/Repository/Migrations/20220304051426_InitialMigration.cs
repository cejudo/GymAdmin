        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Users_LastModifiedBy",
                        column: x => x.LastModifiedBy,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerPayments_Payments_PaymentID",
                        column: x => x.PaymentID,
                        principalTable: "Payments",
                        principalColumn: "PaymentID");
                    table.ForeignKey(
                        name: "FK_CustomerPayments_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "UserID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPayments_CreatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPayments_PaymentID",
                table: "CustomerPayments",
                column: "PaymentID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_LastModifiedBy",
                table: "Payments",
                column: "LastModifiedBy");
